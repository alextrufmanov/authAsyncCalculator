...
Предварительно необходимо убедитесь, что Брандмауэр Windows и антивирус не блокируют обращения к используемым сервисом хосту и порту. Если это необходимо, выполните соответствующую настройку.
